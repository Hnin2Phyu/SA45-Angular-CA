...
@WebServlet(urlPatterns = {"/getFavoriteList/*"})
public class GetFavoriteListServlet extends HttpServlet {

    private static String query = "SELECT * FROM gifphy.favorite where username = ?";
            ...
            throws ServletException, IOException 
    {
		...
		return;
            ...
            while(rs.next())
            {
                ...
                obj.add("gif", rs.getString("gifURL"))
                        .add("id", rs.getInt("id"))
                        .add("title", (rs.getString("title") == null)? "": rs.getString("title"))
                        .add("author", (rs.getString("author") == null)? "": rs.getString("author") );
